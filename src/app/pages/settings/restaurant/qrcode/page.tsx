  ...
  const settingsSections = [
      {
          title: 'Qr Code',
          items: [
              { icon: QrCode, title: 'Generate Qr Code', description: 'Manage your qr code',route: '/pages/settings/restaurant/qrcode/generateqrcode' },
               { icon: Utensils, title: 'Menu url', description: 'View menu url',route: '/pages/settings/restaurant/qrcode/menuurl'},
